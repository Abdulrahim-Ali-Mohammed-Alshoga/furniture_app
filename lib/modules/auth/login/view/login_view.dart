    ...
    return GetBuilder<LoginController>(
      builder: (controller) => Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: getBoldStyle(color: AppColors.black, fontSize: 32.sp),
              ),
              Text(
                controller.isSingIn
          ...
          AnimatedOpacity(
            opacity: controller.isSingIn ?  0.0:1.0 , // التحكم بالشفافية
            duration: const Duration(milliseconds: 400), // مدة الأنيميشن للشفافية
            child: ScaleTransition(
              scale: Tween<double>(
                begin: controller.isSingIn ? 1.0  :0.0, // يبدأ بحجم صغير ويكبر إلى الحجم الطبيعي
                end: controller.isSingIn ?0.0  :1.0 , // يعود لحجم صغير عند الاختفاء
              ).animate(
                CurvedAnimation(
                  ...
                  curve: Curves.easeInOut,
                       ...
                       child:
                       controller.isSingIn?const SizedBox.shrink():   Column(
                         crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(
                'Full Name',
                style: getMediumStyle(color: AppColors.black, fontSize: 13.sp),
              ),
              ...
              UiHelper.verticalSpaceMedium,
              AnimatedOpacity(
                opacity: controller.isSingIn ? 1.0 : 0.0, // التحكم بالشفافية
                duration: const Duration(milliseconds: 400), // مدة الأنيميشن للشفافية
                child: AnimatedSize(
                  duration: const Duration(milliseconds: 400), // مدة الأنيميشن للحجم
                  curve: Curves.easeInOut, // منحنى الحركة لتأثير سلس
                  child: controller.isSingIn
                      ? Row(
                    key: const ValueKey('signInRow'), // مفتاح فريد للحالة
                    ...
                    children: [
                      ...
                      : const SizedBox.shrink(), // الحالة الفارغة عند الاختفاء
                ),
              )
,
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      controller.isSingIn ? 'Sign Up for free' : 'Sign in',
